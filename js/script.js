...
function toggleMenu() {
    ...
    // Alternar la clase 'open' en el menú hamburguesa
    hamburger.classList.toggle('open');
    
    // Alternar la clase 'open' en el menú desplegable
    if (menuresp.style.maxHeight) {
        menuresp.style.maxHeight = null;
    } else {
        menuresp.style.maxHeight = menuresp.scrollHeight + "px";
    }
}
